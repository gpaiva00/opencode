...
type ToolDefs = {
  ...
  codesearch: typeof WebSearchTool
...
function runCodeSearch(p: ToolProps<typeof WebSearchTool>): ToolInline {
  return {
    icon: "◇",
...
function scrollCodeSearchStart(p: ToolProps<typeof WebSearchTool>): string {
...
function permCodeSearch(p: ToolPermissionProps<typeof WebSearchTool>): ToolPermissionInfo {
  const query = p.input.query || ""
  return {
    icon: "◇",
